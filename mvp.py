...
def ai_trading():
    ...
    if result["decision"] == "buy":
        my_krw = upbit.get_balance("KRW") # 업비트 통장 잔고 조회
        if my_krw*0.9995 > 5000: # 최소 주문 금액 5000원 이상이어야 매수
        ...
        current_price = pyupbit.get_orderbook(ticker="KRW-BTC")['orderbook_units'][0]["ask_price"] # 현재가 조회
        if my_btc*current_price > 5000: # 5000원 넘어야 거래 가능
